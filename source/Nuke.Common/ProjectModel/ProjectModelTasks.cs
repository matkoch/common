...
namespace Nuke.Common.ProjectModel
{
    ...
    public static class ProjectModelTasks
    {
        ...
        {
            var msBuildExePathCurrent = Environment.GetEnvironmentVariable("MSBUILD_EXE_PATH");

            try
            {
                if (string.IsNullOrEmpty(msBuildExePathCurrent))
            ...
            {
                Environment.SetEnvironmentVariable("MSBUILD_EXE_PATH", msBuildExePathCurrent);
            }
        }
